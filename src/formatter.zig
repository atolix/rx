...
const trailing_empty_lines = @import("formatter/rules/trailing_empty_lines.zig");
const leading_empty_lines = @import("formatter/rules/leading_empty_lines.zig");
...
const space_after_colon = @import("formatter/rules/space_after_colon.zig");
...
const hash_alignment = @import("formatter/rules/hash_alignment.zig");
...
const rules = [_]rule_types.Rule{
    .{ .apply = leading_empty_lines.apply },
    .{ .apply = trailing_whitespace.apply },
    .{ .apply = trailing_empty_lines.apply },
